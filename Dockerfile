...
ENV TZ=Asia/Jakarta
ENV PHPIZE_DEPS="php7-dev autoconf dpkg-dev dpkg file g++ gcc libc-dev make pkgconf re2c openssl-dev"
...
RUN apk add --no-cache $PHPIZE_DEPS php7-pear && pecl install mongodb \
